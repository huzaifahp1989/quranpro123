...
export const allJuz: Juz[] = [
  ...
  { number: 5, name: "Wal-Muḥsanāt", startSurah: 4, startAyah: 24, endSurah: 5, endAyah: 81, arabicName: "والمحصنات" },
  { number: 6, name: "Lā Yuḥibbullāh", startSurah: 5, startAyah: 82, endSurah: 6, endAyah: 110, arabicName: "لا يحب" },
  { number: 7, name: "Wa Idhā Samiʿū", startSurah: 6, startAyah: 111, endSurah: 7, endAyah: 87, arabicName: "وإذا سمعوا" },
  ...
  { number: 13, name: "Alif Lām Rā", startSurah: 12, startAyah: 53, endSurah: 14, endAyah: 52, arabicName: "الف لام را" },
  ...
  { number: 16, name: "Qāla Alam", startSurah: 18, startAyah: 75, endSurah: 20, endAyah: 135, arabicName: "قال الم" },

...
export function VerseDisplay({ verse, isHighlighted, onVerseClick, onPlayClick }: VerseDisplayProps) {
  ...
  return (
    <div
      className={cn(
        "group relative mb-6 p-5 sm:p-7 border-l-2 transition-all hover-elevate cursor-pointer",
        isHighlighted 
    ...
    >
      ...
      <div className="space-y-4">
        <div 
          className="font-arabic text-3xl sm:text-4xl leading-relaxed sm:leading-loose text-right arabic-verse" 
          dir="rtl"
          lang="ar"
